...
MenuGroup:AddButton("Unload", function()
	Toggles.AutofarmNew:SetValue(false)
	Toggles.Autofarmold:SetValue(false)
	Toggles.Escolhermapaold:SetValue(false)
	Toggles.Warnofdisastersinchat:SetValue(false)
